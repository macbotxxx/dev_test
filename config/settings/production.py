...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["ecasglobal.xyz","www.ecasglobal.xyz"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="dev_test1 <noreply@ecasglobal.xyz>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa F405
    {"url": "https://ecasglobal.xyz", "description": "Production server"}
]
# Your stuff...
# ------------------------------------------------------------------------------
